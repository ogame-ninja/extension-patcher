...
func Test_mustReplaceStr(t *testing.T) {
	...
	tests := []struct {
		...
		{args: args{in: "Some Other Text ToReplace ToReplace Some Other Text", old: "ToReplace", new: "ToReplaceNew", n: -1}, wantOut: "Some Other Text ToReplaceNew ToReplaceNew Some Other Text", name: "1"},
